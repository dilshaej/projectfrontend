         ...
         <div className="row">
          ...
          <div className="col-lg-8">
            ...
            <div className='mb-2'>  <input value={projectData?.language} onChange={e=>setProjectData({...projectData,language:e.target.value})}  type="text" className='form-control' placeholder='Languages used in the project' /></div>
             ...
             <div className='mb-2'> <input value={projectData?.website} onChange={e=>setProjectData({...projectData,website:e.target.website})} type="text" className='form-control' placeholder='Project WEBSITE Link' /></div>
          </div>
          <div className='mb-2'> <input value={projectData?.overview} onChange={e=>setProjectData({...projectData,overview:e.target.value})} type="text" className='form-control' placeholder='Project Overview' /></div>
